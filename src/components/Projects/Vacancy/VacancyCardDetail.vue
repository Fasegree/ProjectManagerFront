<template>
  ...
  >
    <div>
      ...
      <p
        class="flex gap-2 mt-4 text-gray-600 text-sm border-l-4 pl-4 border-gray-300"
      >
        <strong class="font-medium">Field:</strong>
        {{ vacancy.field || "N/A" }}
        <strong class="font-medium border-l-4 pl-4 ml-6 border-gray-300"
          >Country:</strong
        >
        {{ vacancy.country || "N/A" }}
      </p>
    ...
    <div class="w-full">
      <div class="flex gap-3 pt-8 justify-between items-center">
        <div class="text-gray-400">HR Team</div>
